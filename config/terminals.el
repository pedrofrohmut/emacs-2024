...
(evil-define-key 'normal vterm-mode-map (kbd "M-p") 'vterm-send-up)
(evil-define-key 'normal vterm-mode-map (kbd "M-n") 'vterm-send-down)
...
(keymap-set evil-insert-state-map "C-`" #'open-dedicated-at-project-root)
